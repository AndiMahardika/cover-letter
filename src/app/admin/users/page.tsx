...
import { Search, MoreHorizontal, Trash2, Eye, UserX, UserCheck } from "lucide-react"
import {
    Pagination,
    PaginationContent,
    PaginationEllipsis,
...
const initialUsers = [
    ...
    },
    {
        ...
        joinDate: "2024-01-17",
        status: "active",
        coverLettersCount: 14,
        lastActive: "2024-01-20",
    },
    {
        id: 18,
        name: "Patricia Hill",
        email: "patricia.hill@email.com",
        joinDate: "2024-01-04",
        status: "inactive",
        coverLettersCount: 2,
    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-muted-foreground">Kelola semua user yang terdaftar di EasyLetter</p>
            </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Semua user yang terdaftar di sistem EasyLetter</CardDescription>
                        ...
                        <TableBody>
                            {paginatedUsers.map((user) => (
                                <TableRow key={user.id}>
                                    ...
                                    <TableCell>{user.coverLettersCount}</TableCell>
                                                    ...
                                                    <AlertDialog>
                                                        ...
                                                        <AlertDialogContent>
                                                            <AlertDialogHeader>
                                                                ...
                                                                <AlertDialogDescription>
                                                                    Apakah Anda yakin ingin suspend user {user.name}? User yang di-suspend tidak akan bisa
                                                                    mengakses sistem sampai status di-batalkan.
                                                                </AlertDialogDescription>
                                                            </AlertDialogHeader>
                                                            <AlertDialogFooter>
                                                    ...
                                                    <AlertDialogContent>
                                                        <AlertDialogHeader>
                                                            ...
                                                            <AlertDialogDescription>
                                                                ...
                                                                dan akan menghapus semua data terkait user tersebut.
                                                            </AlertDialogDescription>
                                                        </AlertDialogHeader>
                                                        <AlertDialogFooter>
                                                            <AlertDialogCancel>Batal</AlertDialogCancel>
                    ...
                    <AlertDialogContent className="max-w-2xl">
                        ...
                        <div className="space-y-4">
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label className="text-sm font-medium">Cover Letters Dibuat</label>
                                    <p className="text-sm text-muted-foreground">{selectedUser.coverLettersCount}</p>
                                </div>
                                <div>
