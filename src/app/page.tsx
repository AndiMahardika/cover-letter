              ...
              <CardContent className="p-8">
                <div className="mb-8">
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 text-sm leading-relaxed">
                    I am excited about the prospect of joining ROTAR AI and
                    contributing to its continued growth and success. Thank you
                    for considering my application. I would welcome the
                    opportunity to discuss how my skills and qualifications
                    align with your needs in more detail. Please find my
                    attached resume for your review.
                  </div>
                </div>
                <h3 className="text-2xl font-bold">
                    ...
                    <div className="bg-gray-100 border border-gray-200 rounded-lg p-4 flex items-center justify-between">
                      <div>
                        ...
                        <div className="text-sm text-gray-600">
                          High-quality content of your document
                        </div>
                      </div>
